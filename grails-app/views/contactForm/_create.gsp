...
<%@ page import="uk.co.anthonycampbell.grails.plugins.contactform.ContactForm" %>
                    ...
                    <g:hasErrors bean="${contactFormInstance}">
                        ...
                        code="uk.co.anthonycampbell.grails.plugins.contactform.ContactForm.validation.fail.message"
                        ...
                        onLoaded="displayResponse('createContactForm')">
                            <fieldset>
                                <legend><g:message code="uk.co.anthonycampbell.grails.plugins.contactform.ContactForm.legend" default="Contact form" /></legend>
    
                                <p><label for="yourFullName"><g:message code="uk.co.anthonycampbell.grails.plugins.contactform.ContactForm.yourFullName.label" default="Your Full Name" />:</label>
                                ...
                                <p><label for="yourEmailAddress"><g:message code="uk.co.anthonycampbell.grails.plugins.contactform.ContactForm.yourEmailAddress.label" default="Your Email Address" />:</label>
                                ...
                                <p><label for="subject"><g:message code="uk.co.anthonycampbell.grails.plugins.contactform.ContactForm.subject.label" default="Subject" />:</label>
                                ...
                                <p><label for="message"><g:message code="uk.co.anthonycampbell.grails.plugins.contactform.ContactForm.message.label" default="Message" />:</label>
                                ...
                                <p><label for="captcha"><g:message code="uk.co.anthonycampbell.grails.plugins.contactform.ContactForm.captcha.label" default="Captcha" />:</label>
